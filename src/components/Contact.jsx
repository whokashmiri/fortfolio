...
const Contact = () => {
  return (
    <>
      <div className="min-h-fit flex flex-col justify-center items-center h-fit w-screen bg-accent dark:bg-primary p-6 sm:p-14">
        <div className="w-full sm:w-[61%] h-auto sm:h-[90%] bg-accent text-black dark:bg-secondary rounded-3xl shadow-lg flex flex-col justify-start items-center p-6 sm:p-8">
          <h1 className="text-3xl sm:text-4xl text-gray-900 dark:text-white font-bold mb-2 text-start">RING A BELL!</h1>

          {/* Form Section */}
          <h3 className="text-lg sm:text-xl font-semibold text-gray-600 dark:text-gray-300 uppercase pt-4">Fill This Form</h3>
          ...
          <div className="w-full mt-6  sm:p-8 rounded-2xl">
            <h1 className="text-3xl sm:text-4xl text-gray-900 dark:text-white font-bold mb-2">RING A BELL!</h1>
